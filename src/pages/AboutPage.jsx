...
const aboutImages = {
  engineers: 'https://images.unsplash.com/photo-1531482615713-2afd69097998?w=600&h=600&fit=crop&crop=center&q=100',
  founders: 'https://images.unsplash.com/photo-1560250097-0b93528c311a?w=600&h=600&fit=crop&crop=top&q=100',
}
      ...
      <div className="relative z-10 w-full max-w-[900px] mx-auto px-5 md:px-10 flex flex-col items-center text-center">
        <h1 className="font-display text-[32px] sm:text-[44px] md:text-[60px] lg:text-[72px] leading-[1.1] tracking-tight text-white">
          <span className="block">
            <AnimatedChars text="Built by" />
            <InlineImage
              src={aboutImages.engineers}
              alt="Engineers"
              delay={0.6}
              floatY={6}
              floatDuration={3.0}
              rotateDeg={2}
            />
            <span className="text-primary-light"><AnimatedChars text="Engineers" /></span>
          </span>
          <span className="block mt-1">
            <AnimatedChars text="Trusted by" />
            <InlineImage
              ...
              rotateDeg={2.5}
            />
            <span className="text-primary-light"><AnimatedChars text="Founders" /></span>
          </span>
        </h1>
      </div>
    </section>
