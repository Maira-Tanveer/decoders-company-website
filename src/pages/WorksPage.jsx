...
const workImages = {
  design: 'https://images.unsplash.com/photo-1561070791-2526d30994b5?w=600&h=600&fit=crop&crop=center&q=100',
  code: 'https://images.unsplash.com/photo-1555066931-4365d14bab8c?w=600&h=600&fit=crop&crop=center&q=100',
}
      ...
      <div className="relative z-10 w-full max-w-[900px] mx-auto px-5 md:px-10 flex flex-col items-center text-center">
        <h1 className="font-display text-[32px] sm:text-[44px] md:text-[60px] lg:text-[72px] leading-[1.1] tracking-tight text-white">
          <span className="block">
            <AnimatedChars text="Our Work" />
            <InlineImage
              src={workImages.design}
              alt="Design work"
              delay={0.6}
              floatY={6}
              floatDuration={3.0}
              rotateDeg={2}
            />
            <span className="text-primary-light"><AnimatedChars text="In Action" /></span>
          </span>
          <span className="block mt-1">
            <AnimatedChars text="Featured" />
            <InlineImage
              src={workImages.code}
              alt="Code work"
              delay={0.9}
              ...
              rotateDeg={2.5}
            />
            <span className="text-primary-light"><AnimatedChars text="Work" /></span>
          </span>
        </h1>
      </div>
    </section>
